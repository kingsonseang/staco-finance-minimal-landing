        ...
        <UContainer>
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="relative" @mouseenter="handleMouseEnter" @mouseleave="handleMouseLeave">
                    ...
                    <div class="absolute -left-8 top-0 w-64 h-80 bg-[#004D42] rounded-tr-[200px]"
                    ...
                    <div class="relative ml-16">
                        <div class="w-72 h-80 bg-[#B2EDA1] rounded-t-full overflow-hidden">
                            <Transition name="fade" mode="out-in">
                                <img :key="currentIndex" :src="testimonials[currentIndex].image"
                ...
                <div class="space-y-6 relative" @mouseenter="handleMouseEnter" @mouseleave="handleMouseLeave">
                    <!-- Quote icon -->
                    <div
                    ...
                    <Transition name="fade" mode="out-in">
                        <div :key="currentIndex" class="space-y-6">
                            <blockquote class="text-base text-[#111111] leading-[30px] font-medium pt-12"
                                style="font-family: 'DM Sans', sans-serif;">
                                {{ testimonials[currentIndex].quote }}
                            </blockquote>

                            <div class="space-y-1">
                                <p class="text-lg font-bold text-[#111111]" style="font-family: 'DM Sans', sans-serif;">
                    ...
                    <div class="flex items-center gap-3 pt-4">
                        <button v-for="(testimonial, index) in testimonials" :key="index" @click="goTo(index)"
                            class="transition-all duration-300" :class="index === currentIndex
                    ...
                    <div class="flex flex-wrap items-center gap-8 pt-8 border-t border-gray-300">
                        <img v-for="(company, index) in companies" :key="index" :src="company.image" :alt="company.name"
