...
<template>
  ...
  >
    <span class="inline-block transition-transform duration-800 ease-[cubic-bezier(0.15,0.85,0.31,1)] group-hover:-translate-y-[150%] max-md:text-sm">
      <span class="relative z-11 text-white transition-opacity duration-600 ease-[cubic-bezier(0.15,0.85,0.31,1)] group-hover:opacity-0 group-hover:text-[#111111]">
        <slot />
      </span>
      <span class="inline-block absolute w-full top-1/2 left-1/2 -translate-x-1/2 translate-y-[80%] opacity-0 z-11 text-white transition-all duration-600 ease-[cubic-bezier(0.15,0.85,0.31,1)] group-hover:translate-y-full group-hover:opacity-100 group-hover:text-[#111111]">
        <slot />
      </span>
    </span>
  </component>
